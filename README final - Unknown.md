...
# Real command 
aws ecr get-login-password --region us-west-2 | docker login --username \
samrogers --password-stdin REDACTED-AWS-ACCOUNT-ID.dkr.ecr.us-west-2.amazonaws.com/sams-collectibles
```
...
docker tag sams-collectibles:latest REDACTED-AWS-ACCOUNT-ID.dkr.ecr.us-west-2.amazonaws.com/sams-collectibles:latest

# docker push <your_account_id>.dkr.ecr.<region>.amazonaws.com/sams-collectibles:latest
docker push REDACTED-AWS-ACCOUNT-ID.dkr.ecr.us-west-2.amazonaws.com/sams-collectibles:latest
```
...
|+-----------+-----------+-----------------------+---------------+-------------+-----------+-------------------------+----------+|
||  0.0.0.0/0|  80       |  sg-029eb602389458954 |  REDACTED-AWS-ACCOUNT-ID |  tcp        |  False    |  sgr-02918aafb28d98b31  |  80      ||
|+-----------+-----------+-----------------------+---------------+-------------+-----------+-------------------------+----------+|
```
...
|||                                    GroupId                                    |                       UserId                        |||
||+-------------------------------------------------------------------------------+-----------------------------------------------------+||
|||  sg-00242036d9be9884a                                                         |  REDACTED-AWS-ACCOUNT-ID                                       |||
||+-------------------------------------------------------------------------------+-----------------------------------------------------+||
||                                                                Ingress                                                                ||
|+--------------------------------------------+----------------------------------------------------+-------------------------------------+|
||                  FromPort                  |                    IpProtocol                      |               ToPort                ||
...
|||                                    GroupId                                    |                       UserId                        |||
||+-------------------------------------------------------------------------------+-----------------------------------------------------+||
|||  sg-029eb602389458954                                                         |  REDACTED-AWS-ACCOUNT-ID                                       |||
||+-------------------------------------------------------------------------------+-----------------------------------------------------+||
```
...
||  registeredBy     |  arn:aws:iam::REDACTED-AWS-ACCOUNT-ID:root                                                ||
||  revision         |  1                                                                             ||
||  status           |  ACTIVE                                                                        ||
||  taskDefinitionArn|  arn:aws:ecs:us-west-2:REDACTED-AWS-ACCOUNT-ID:task-definition/sams-collectibles-task:1   ||
|+-------------------+--------------------------------------------------------------------------------+|
|||                                          compatibilities                                         |||
||+--------------------------------------------------------------------------------------------------+||
|||  EC2                                                                                             |||
...
||                                                                service                                                                ||
|+-------------------------------+-------------------------------------------------------------------------------------------------------+|
||  clusterArn                   |  arn:aws:ecs:us-west-2:REDACTED-AWS-ACCOUNT-ID:cluster/sams-collectibles-ecs-cluster                             ||
||  createdAt                    |  2024-11-09T20:17:42.190000-08:00                                                                     ||
||  createdBy                    |  arn:aws:iam::REDACTED-AWS-ACCOUNT-ID:root                                                                       ||
||  desiredCount                 |  1                                                                                                    ||
...
||  propagateTags                |  NONE                                                                                                 ||
||  roleArn                      |  arn:aws:iam::REDACTED-AWS-ACCOUNT-ID:role/aws-service-role/ecs.amazonaws.com/AWSServiceRoleForECS               ||
||  runningCount                 |  0                                                                                                    ||
||  schedulingStrategy           |  REPLICA                                                                                              ||
||  serviceArn                   |  arn:aws:ecs:us-west-2:REDACTED-AWS-ACCOUNT-ID:service/sams-collectibles-ecs-cluster/sams-collectibles-service   ||
||  serviceName                  |  sams-collectibles-service                                                                            ||
||  status                       |  ACTIVE                                                                                               ||
||  taskDefinition               |  arn:aws:ecs:us-west-2:REDACTED-AWS-ACCOUNT-ID:task-definition/sams-collectibles-task:1                          ||
|+-------------------------------+-------------------------------------------------------------------------------------------------------+|
...
|+------------------------------------------------------+----------------------------+-------+------------------------+------------------------+|
||  arn:aws:iam::REDACTED-AWS-ACCOUNT-ID:role/ecsTaskExecutionRole |  2024-11-10T04:51:40+00:00 |  /    |  AROAUS4BROS3BCQ3BQ7Y7 |  ecsTaskExecutionRole  ||
|+------------------------------------------------------+----------------------------+-------+------------------------+------------------------+|
